...
public enum Objective {
    ...
    OBJECTIVE9("Destroy all the Yellow troops. Note: If the Yellow troops are not present " +
               ...
               "eliminated by another player, your objective becomes conquering 24 territories.", "objective9"),
    OBJECTIVE10("Destroy all the Red troops. Note: If the Red troops are not present " +
                ...
                "eliminated by another player, your objective becomes conquering 24 territories.", "objective10"),
    OBJECTIVE11("Destroy all the Green troops. Note: If the Green troops are not present " +
                ...
                "eliminated by another player, your objective becomes conquering 24 territories.", "objective11"),
    OBJECTIVE12("Destroy all the Blue troops. Note: If the Blue troops are not present " + 
                ...
                "eliminated by another player, your objective becomes conquering 24 territories.", "objective12"),
    OBJECTIVE13("Destroy all the Pink troops. Note: If the Pink troops are not present " +
                ...
                "eliminated by another player, your objective becomes conquering 24 territories.", "objective13"),
    OBJECTIVE14("Destroy all the Black troops. Note: If the Black troops are not present " +  
                ...
                "eliminated by another player, your objective becomes conquering 24 territories.", "objective14"),
    ...
    /* Constructor */
    Objective (String objectiveDescription, String id) {
