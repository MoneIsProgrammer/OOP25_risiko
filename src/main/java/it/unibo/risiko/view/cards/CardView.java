...
public class CardView {
    ...
    public Optional<List<Card>> show(Player player) {
        ...
        dialog.setContentText("Press Play when you have selected the cards you want to play, press Cancel if you don't want to play any cards.");

        /** FlowPane helps arrange the hand */
        FlowPane handPane = new FlowPane(10, 10);
        ...
        ButtonType okType = new ButtonType("Play", ButtonBar.ButtonData.OK_DONE);
        ...
        dialog.setResultConverter(bt ->
            bt == okType ? new ArrayList<>(chosenCards) : null);
     ...
     */
    private void setCombo(Card card, ImageView cardView) {
